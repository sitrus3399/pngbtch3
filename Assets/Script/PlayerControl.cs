...
public class PlayerControl : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        else if (collision.gameObject.name == "FireBall")
        {
            score = -1;
            collision.gameObject.SendMessage("RestartGame", Random.Range(2, 5), SendMessageOptions.RequireReceiver);
        }
        else if (collision.gameObject.name == "PowerUpBall")
        {
