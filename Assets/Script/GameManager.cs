...
public class GameManager : MonoBehaviour
{
    ...
    public FireBallControl fireBall; // skrip
    public FireBallControl powerUpBall; // skrip
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(Screen.width / 2 - 60, 35, 120, 53), "RESTART"))
        {
            ...
            powerUpBall.SendMessage("RestartGame", 0.5f, SendMessageOptions.RequireReceiver);
